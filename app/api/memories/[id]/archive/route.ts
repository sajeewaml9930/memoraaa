...
export async function POST(
  ...
  try {
    ...
    const resolvedArchived = nextArchived === undefined ? !memory.isArchived : nextArchived;
    ...
    return NextResponse.json({ error: "Failed to toggle memory archive status" }, { status: 500 });
  }
}
